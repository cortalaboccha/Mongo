...
public class javamongo { 
    ...
    public void connectDatabase(){
        ...
        setMongodb(getMongoClient().getDatabase("tarea3"));
    }
    /**
    ...
    public void insertOneDataTest(){
        try {            
            ...
            Logger.getLogger(javamongo.class.getName()).log(Level.SEVERE, null, ex);
        }        
    }
    ...
    public static void main(String args[]){
        javamongo javaMongodbInsertData = new javamongo();
